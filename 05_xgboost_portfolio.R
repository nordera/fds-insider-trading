...
cat("=================================================\n")
cat("  XGBoost Insider Trading — Expanding Window\n")
cat("=================================================\n")
...
summarise_port(port_xgb$ret_ls_xgb,     "XGBoost Decile 10-1")
summarise_port(port_xgb20$ret_ls_xgb20, "XGBoost Top/Bot 20%")
cat(rep("-", 75), "\n", sep = "")
...
cat(sprintf("  XGBoost Decile 10-1: $%.2f\n", tail(wealth$wealth_xgb,   1)))
cat(sprintf("  XGBoost Top/Bot 20%%: $%.2f\n", tail(wealth$wealth_xgb20, 1)))
...
), "~/nordera/xgboost_results.rds")

cat("\nSaved ~/nordera/xgboost_results.rds\n")
cat("=== DONE ===\n")
